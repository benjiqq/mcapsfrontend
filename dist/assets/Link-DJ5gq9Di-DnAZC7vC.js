import{d4 as s,ds as l}from"./app-DJtU2-AF.js";let c=l.a`
  && {
...
`;const p=({size:r="md",variant:e="navigation",disabled:n=!1,as:a,children:t,onClick:o,...d})=>s.jsx(c,{as:a,$size:r,$variant:e,$disabled:n,onClick:i=>{n?i.preventDefault():o==null||o(i)},...d,children:t});export{p as n};
